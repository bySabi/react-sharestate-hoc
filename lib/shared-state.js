...
var sharedState = exports.sharedState = function sharedState(C) {
  var prop = arguments.length <= 1 || arguments[1] === undefined ? 'sharedComponent' : arguments[1];
...
var getComponentInstance = exports.getComponentInstance = function getComponentInstance(store) {
  ...
  return new Promise(function (resolve, reject) {
    return store._shareInstance && resolve(store._shareInstance) || setTimeout(function () {
      return store._shareInstance && resolve(store._shareInstance);
    }, ms);
  });
};